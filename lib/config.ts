...
const ENABLE_LIFI_EARN_CHAT = process.env.NEXT_PUBLIC_ENABLE_LIFI_EARN_CHAT !== 'false';

export { API_BASE, LANGGRAPH_API_BASE, SOLANA_RPC_URL, ENABLE_LIFI_EARN_CHAT };
