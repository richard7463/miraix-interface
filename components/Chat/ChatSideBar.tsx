...
export const ChatSideBar = () => {
  ...
  return (
    <Flex direction="column" className={cs('chat-side-bar', { show: toggleSidebar })} style={{ backgroundColor: theme === 'light' ? '#F8F9FB' : '#111217', position: 'relative', minHeight: '100vh', paddingTop: '76px' }}>
      <Flex className="p-2 h-full overflow-hidden w-full" direction="column" gap="3" style={{ backgroundColor: theme === 'light' ? '#F8F9FB' : '#111217', flex: 1, minHeight: 0 }}>
        ...
        <div className="mt-auto pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col gap-2 px-2">
            <Text size="1" className="text-gray-500 dark:text-gray-400 text-center">
              Connect with us
            </Text>
