...
import { FiPlus, FiCheckSquare, FiServer, FiClock, FiActivity, FiZap } from 'react-icons/fi'
...
export const ChatSideBar = () => {
  ...
  return (
    <Flex direction="column" className={cs('chat-side-bar', { show: toggleSidebar }) + ' shadow-lg border-r border-gray-700 z-50 bg-zinc-800'} style={{ position: 'relative', height: 'calc(100vh - 46px)' }}>
      <Flex className="p-3 h-full overflow-hidden w-full" direction="column" gap="4" style={{ flex: 1, minHeight: 0 }}>
        ...
        <div className="mt-auto pt-4 border-t border-gray-600">
          <div className="flex flex-col gap-3 px-3">
            ...
            <div className="flex justify-center gap-4">
              <a href="https://x.com/Miraix_Ai" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                <span className="sr-only">Twitter</span>
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
            </svg>
              </a>
              <a href="https://github.com/miraixai" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-200 transition-colors duration-200">
      ...
      <SidePanel isOpen={isPanelOpen} onClose={() => setIsPanelOpen(false)}>
        <div className="space-y-4">
          <div className="rounded-lg border border-gray-600 p-4 bg-gray-800/50 backdrop-blur-sm">
            <h3 className="mb-2 text-lg font-medium text-gray-200">Chat Settings</h3>
          ...
          <div className="rounded-lg border border-gray-600 p-4 bg-gray-800/50 backdrop-blur-sm">
            <h3 className="mb-2 text-lg font-medium text-gray-200">Task Management</h3>
            <p className="text-gray-400">
          ...
          <div className="rounded-lg border border-gray-600 p-4 bg-gray-800/50 backdrop-blur-sm">
            <h3 className="mb-2 text-lg font-medium text-gray-200">Strategy Settings</h3>
            <p className="text-gray-400">
