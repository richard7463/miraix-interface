      ...
      (
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
            ...
            <div style={{ fontSize: 42, color: "#d8c7a4" }}>
              Today&apos;s Orders
            </div>
            <div
              style={{
    ...
    (
      <div
        style={{
          ...
          background:
            "radial-gradient(circle at top left, rgba(250,204,21,0.18), transparent 24%), radial-gradient(circle at top right, rgba(56,189,248,0.12), transparent 24%), linear-gradient(180deg, #111114 0%, #09090b 46%, #060607 100%)",
          color: "#fff7e6",
          fontFamily: "serif",
          fontSize: 88,
          fontWeight: 700,
