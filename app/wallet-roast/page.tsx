...
const COPY = {
  en: {
    ...
    docsCta: 'Install on OpenClaw',
    docsHint: 'Published on ClawHub. Install the skill and use it in your own OpenClaw.',
  ...
  zh: {
    ...
    analyze: '分析这个钱包',
    docsCta: '安装到 OpenClaw',
    docsHint: '已经上架 ClawHub。安装 skill 后就能在自己的 OpenClaw 里使用。',
