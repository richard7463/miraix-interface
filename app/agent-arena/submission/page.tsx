...
export default async function AgentArenaSubmissionPage() {
  ...
  if (!selected) {
    return (
      <main className="min-h-screen bg-[#f7f3ec] text-[#171d2d]">
        <div className="mx-auto max-w-[1280px] px-8 py-10">
          <Link href="/agent-arena" className="inline-flex items-center gap-2 text-sm text-[#7d7468]">
          ...
          <div className="mt-10 rounded-[32px] border border-[#eadfce] bg-white px-8 py-10 shadow-[0_20px_60px_rgba(23,29,45,0.06)]">
            ...
            <p className="mt-4 max-w-[760px] text-[18px] leading-8 text-[#5b6270]">
              Submit one agent to Arena first. This page only renders runner-backed evidence from real OKX demo activity.
            </p>
          </div>
        </div>
      </main>
  ...
  const criteria = [
    {
      title: "Agent Trade Kit integration",
      body: "User submission enters Arena, starts the demo runner, and writes real OKX demo orders, fills, and equity snapshots.",
      icon: Bot,
    },
    {
      title: "Practicality",
      body: "This is not a mock leaderboard. The detail and submission views are backed by persisted runner data and current OKX market/account state.",
      ...
      <div className="mx-auto max-w-[1360px] px-8 py-10">
        <header className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <div className="mt-6 text-[12px] uppercase tracking-[0.2em] text-[#9a8d7b]">OKX Agent Trade Kit Submission</div>
            <h1 className="mt-3 max-w-[920px] text-[58px] font-semibold leading-[1.02] tracking-[-0.08em] text-[#1F2937]">
              Public Agent Arena with real OKX demo runner evidence.
            </h1>
            <p className="mt-5 max-w-[920px] text-[20px] leading-9 text-[#5b6270]">
              Users submit an agent to Arena, it becomes visible immediately, enters an automatic demo runner, trades on OKX demo,
              and persists orders, fills, positions, and equity snapshots for public inspection.
            </p>
          </div>
          <Link
            href={`/agent-arena/${agent.id}`}
            className="inline-flex items-center gap-2 rounded-full border border-[#ddd2c2] bg-white px-5 py-3 text-sm font-medium text-[#2f3545] shadow-[0_12px_32px_rgba(23,29,45,0.05)]"
          >
          ...
          <div className="rounded-[34px] border border-[#eadfce] bg-white px-8 py-8 shadow-[0_24px_60px_rgba(23,29,45,0.06)]">
            ...
            <div className="mt-6 space-y-4">
              {[
                ...
                {
                  title: "3. OKX demo order executed",
                  body: latestOrder
          ...
          <div className="rounded-[34px] border border-[#eadfce] bg-white px-8 py-8 shadow-[0_24px_60px_rgba(23,29,45,0.06)]">
            ...
            <div className="mt-6 rounded-[22px] border border-[#efe7dc] bg-[#fff7ee] px-5 py-5">
              ...
              <ul className="mt-4 space-y-3 text-[16px] leading-7 text-[#4b5563]">
                <li><strong>Real:</strong> submitted agent, demo runner, market sync, demo orders, fills, positions, equity snapshots.</li>
